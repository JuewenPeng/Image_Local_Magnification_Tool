...
After activating one magnification window, you can click the center of the magnified area in the right image to determine where to magnifiy. If the magnified area exceeds the range of the cropped original image, the corresponding magnification window will not display.
